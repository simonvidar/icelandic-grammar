drop function if exists public.select_random_word_for_difficulty(text);

drop function if exists public.select_random_word_for_difficulty(text, uuid);

create or replace function public.select_random_word_for_difficulty(
  p_difficulty text,
